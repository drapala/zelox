...
class CallChainAnalyzer(ast.NodeVisitor):
    ...
    def __init__(self, file_path: Path):
        ...
        self.function_calls: dict[str, set[str]] = defaultdict(
            set
        )  # function -> set of called functions
        self.method_calls: dict[str, set[str]] = defaultdict(set)  # method -> set of called methods
        self.class_methods: dict[str, set[str]] = defaultdict(set)  # class -> set of methods
        self.current_function = None
        self.current_class = None
        self.external_calls: set[str] = set()  # Calls to external modules
...
class SemanticDependencyAnalyzer:
    ...
    def __init__(self, repo_root: str = "."):
        ...
        self.file_dependencies: dict[str, CallChainAnalyzer] = {}  # file -> CallChainAnalyzer
        self.import_graph: dict[str, set[str]] = defaultdict(set)  # module -> imported modules
